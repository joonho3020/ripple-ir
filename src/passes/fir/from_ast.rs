...
// unimplemented!();
        ...
        Stmt::Memory(name, tpe, depth, rlat, wlat, ports, ruw, _info) => {
            ...
            let memory_type = memory_type_from_ports(ports, *depth, tpe);
...
pub fn memory_type_from_ports(ports: &MemoryPorts, depth: u32, base_type: &Type) -> Type {
    ...
    for port in ports {
        ...
        let port_type = match port.as_ref() {
            MemoryPort::Read(_) => {
                ...
                let fields = vec![
                    Box::new(Field::Straight(Identifier::Name("data".to_string()), Box::new(base_type.clone()))),
            ...
            MemoryPort::Write(_) => {
                ...
                let fields = vec![
                    ...
                    Box::new(Field::Flipped(Identifier::Name("en".to_string()), Box::new(Type::TypeGround(TypeGround::UInt(Some(Width(1))))))),
                    Box::new(Field::Flipped(Identifier::Name("clk".to_string()), Box::new(Type::TypeGround(TypeGround::Clock)))),
                    Box::new(Field::Flipped(Identifier::Name("data".to_string()), Box::new(base_type.clone()))),
            ...
            MemoryPort::ReadWrite(_) => {
                ...
                let fields = vec![
                    Box::new(Field::Straight(Identifier::Name("rdata".to_string()), Box::new(base_type.clone()))),
                    Box::new(Field::Flipped(Identifier::Name("addr".to_string()), Box::new(Type::TypeGround(TypeGround::UInt(Some(addr_width)))))),
                    Box::new(Field::Flipped(Identifier::Name("en".to_string()), Box::new(Type::TypeGround(TypeGround::UInt(Some(Width(1))))))),
                    Box::new(Field::Flipped(Identifier::Name("clk".to_string()), Box::new(Type::TypeGround(TypeGround::Clock)))),
                    Box::new(Field::Flipped(Identifier::Name("wmode".to_string()), Box::new(Type::TypeGround(TypeGround::UInt(Some(Width(1))))))),
                    Box::new(Field::Flipped(Identifier::Name("wdata".to_string()), Box::new(base_type.clone()))),
    ...
    // Create the aggregate type for the memory containing all port types
     Type::TypeAggregate(Box::new(TypeAggregate::Fields(Box::new(memory_fields))))
}
